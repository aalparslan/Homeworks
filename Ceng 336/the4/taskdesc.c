...
volatile unsigned char stacktask0[DEFAULT_STACK_SIZE];
...
rom_desc_tsk rom_desc_task0 = {
    ...
    stacktask0,                           /* stack address (16 bits)     */
    TASK0,                            /* start address (16 bits)     */
    READY,                            /* state at init phase         */
    TASK0_ID,                         /* id_tsk from 0 to 15         */
    sizeof(stacktask0)                    /* stack size    (16 bits)     */
};
